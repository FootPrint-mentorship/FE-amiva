/**
 * All country calling codes — GENERATED 23 Sep 2026 from the mledoze/countries
 * dataset (idd roots+suffixes; manual overrides: EH→+212, VA→+39, UM→+1).
 * `name` is the English fallback; the UI prefers Intl.DisplayNames for the
 * viewer's locale. Shared codes (+1, +44, +7…) are correct: E.164 assembly
 * only needs the dial prefix. Regenerate from the dataset — don't hand-edit.
 */
...
export const allCountries: Country[] = [
  ...
  { iso: "UM", dial: "+1", name: "United States Minor Outlying Islands" },
